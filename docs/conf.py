...
import aind_bci_no_movement

SOURCE_ROOT = "https://github.com/AllenNeuralDynamics/Aind.Behavior.BciNoMovement/tree/main/src/DataSchemas/"
...
export_model_diagram(aind_bci_no_movement.task_logic.BciNoMovementTaskLogic, _diagram_root)
